...
date: '2026-06-23T13:38:04-07:00'
draft: true
...
This is the one content type for anything you sell or provide --
...
the front matter fields above — there's nothing to add in the body
for those.

  - offering_type     -> free text, e.g. "Product" or "Service".
                         Leave blank to hide the badge entirely. (Note:
                         this is named offering_type, not type --
                         "type" is a reserved Hugo front matter key
                         that controls layout lookup, and setting it
                         would silently break this page's template.)
