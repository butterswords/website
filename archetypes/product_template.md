...
<!--
PRODUCT TEMPLATE — a polished pitch page for a product.

  hugo new --kind product_template content/products/my-product.md

`layouts/products/single.html` renders the tagline, price badge, and
