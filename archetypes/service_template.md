...
<!--
SERVICE TEMPLATE — a polished pitch page for a service.

  hugo new --kind service_template content/services/my-service.md

`layouts/services/single.html` renders the tagline, price badge, and
CTA buttons automatically from the front matter above — there's
nothing to add in the body for those.
